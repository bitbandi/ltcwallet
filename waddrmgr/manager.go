...
import (
	...
	"github.com/bitbandi/luxwallet/snacl"
...
//
// This function MUST be called with the manager lock held for writes.
func (m *Manager) loadAndCacheAddress(ns walletdb.ReadBucket, address luxutil.Address) (ManagedAddress, error) {
...
func (m *Manager) Address(ns walletdb.ReadBucket, address luxutil.Address) (ManagedAddress, error) {
	...
	if pka, ok := address.(*luxutil.AddressPubKey); ok {
...
func (m *Manager) AddrAccount(ns walletdb.ReadBucket, address luxutil.Address) (uint32, error) {
...
func (m *Manager) ImportPrivateKey(ns walletdb.ReadWriteBucket, wif *luxutil.WIF, bs *BlockStamp) (ManagedPubKeyAddress, error) {
	...
	pubKeyHash := luxutil.Hash160(serializedPubKey)
...
func (m *Manager) MarkUsed(ns walletdb.ReadWriteBucket, address luxutil.Address) error {
...
func (m *Manager) ForEachActiveAddress(ns walletdb.ReadBucket, fn func(addr luxutil.Address) error) error {
	m.mtx.Lock()
	defer m.mtx.Unlock()
